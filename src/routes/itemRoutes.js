...
router
  .route("/")
  .post(itemController.uploadItemImage, itemController.resizeImage, itemController.createItem)
...
router.route("/status").get(restrictTo("admin", "super-admin"), itemController.getItemsByStatus);
router
  .route("/:id")
